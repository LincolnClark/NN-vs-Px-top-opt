import torch
from utils.material import Si3N4, SiO2, void
...
options = {
        ...
        "t": 500, # thickness of the design domain
        "mat 1": 1., # permittivity when density is 0
        "mat 2": Si3N4.eps(lam), # permittivity when density is 1
        "superstrate": 1., # Superstrate permittivity
        "substrate": SiO2.eps(lam), # substrate permittivity
        "Lx": 400, # Period along x
        "Ly": 400, # Period along y
