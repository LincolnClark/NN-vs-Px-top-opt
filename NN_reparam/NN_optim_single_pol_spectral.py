...
from NN_reparam.neural_network_architectures import train_loop_single_spectral as train_loop
...
def NN_optim_pol(seed, wavelengths, target, pol, layers, options, sim_dtype, geo_dtype, device):
